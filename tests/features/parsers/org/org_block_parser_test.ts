...
Deno.test("unit: OrgBlockParser: parseOrgBlocks extracts author metadata property", () => {
    const input = "#+TITLE: Disambiguation Test\n#+AUTHOR: DeepMind\n";
    const doc = parseOrgDocument(input);
    assertEquals(doc.properties?.author, "DeepMind");
});

Deno.test("unit: OrgBlockParser: parseOrgBlocks parses source block language parameter", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses source block body", () => {
    const input = "#+BEGIN_SRC python\ndef hello():\n    print('world')\n#+END_SRC";
    const doc = parseOrgDocument(input);
    const srcBlock = doc.children[0] as OrgBlockElement;
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses quote block body", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses dynamic block name", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses dynamic block arguments", () => {
    const input = "#+BEGIN: clocktable :maxlevel 2 :scope file\n| Headline | Time |\n#+END:";
    const doc = parseOrgDocument(input);
    const dyn = doc.children[0] as OrgDynamicBlockElement;
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks scopes affiliated keywords to following element", () => {
    const input =
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks preserves detached keywords as standalone children", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks nests headlines into hierarchical tree via level stack", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses sibling headlines at same level", () => {
    const input = "* Level 1 Heading\n* Sibling Level 1\nSibling text.";
    const doc = parseOrgDocument(input);
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses headline TODO keyword", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses headline priority cookie", () => {
    const input = "* TODO [#A] Urgent task :work:urgent:\nTask description.";
    const doc = parseOrgDocument(input);
    const headline = doc.children[0] as OrgHeadlineElement;
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses headline tags", () => {
    const input = "* TODO [#A] Urgent task :work:urgent:\nTask description.";
    const doc = parseOrgDocument(input);
    const headline = doc.children[0] as OrgHeadlineElement;
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses headline planning deadlines", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks attaches property drawer values to headline properties", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks preserves property drawer in headline children", () => {
    const input = "* Configured Headline\n:PROPERTIES:\n:CUSTOM_ID: headline-1\n:END:\nHeadline text.";
    const doc = parseOrgDocument(input);
    const headline = doc.children[0] as OrgHeadlineElement;
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses pipe table header rows", () => {
    const input = "| ID | Name |\n|----+------|\n| 1  | Alice |";
    const doc = parseOrgDocument(input);
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses pipe table separator rule", () => {
    const input = "| ID | Name |\n|----+------|\n| 1  | Alice |";
    const doc = parseOrgDocument(input);
    const table = doc.children[0] as OrgTableElement;
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks leniently normalizes incomplete pipe table rows", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses list checked state and counter cookie", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses list description terms", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses nested sublists within list items", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses ordered lists", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses Org comment lines", () => {
    const input = "# This is an Org comment\nParagraph.";
    const doc = parseOrgDocument(input);
    assertEquals(doc.children[0].type, "comment");
});

Deno.test("unit: OrgBlockParser: parseOrgBlocks parses fixed-width lines", () => {
    const input = ": fixed-width line 1\n: fixed-width line 2";
    const doc = parseOrgDocument(input);
    assertEquals(doc.children[0].type, "fixed_width");
});

Deno.test("unit: OrgBlockParser: parseOrgBlocks parses horizontal rule elements", () => {
    const input = "-----\nParagraph.";
    const doc = parseOrgDocument(input);
    assertEquals(doc.children[0].type, "horizontal_rule");
});

Deno.test("unit: OrgBlockParser: parseOrgBlocks parses LaTeX begin-end environments", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses multiline display dollar blocks", () => {
    const input = "$$\n\\int e^{-x^2} dx\n$$";
    const doc = parseOrgDocument(input);
    const env = doc.children[0] as OrgLatexEnvironmentElement;
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses single-line display dollar blocks", () => {
...
Deno.test("unit: OrgBlockParser: parseOrgBlocks parses bracket display math blocks", () => {
    const input = "\\[\n\\sum_{k=1}^n k\n\\]";
    const doc = parseOrgDocument(input);
    const env = doc.children[0] as OrgLatexEnvironmentElement;
