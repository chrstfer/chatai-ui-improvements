...
Deno.test("unit: OrgSerializer: serializeOrgElement serializes source code blocks with language hint", () => {
...
Deno.test("unit: OrgSerializer: serializeOrgElement preserves code block body content", () => {
    const raw = "#+BEGIN_SRC python\ndef hello():\n    return 42\n#+END_SRC";
    const doc = parseOrgDocument(raw);
    const blockStr = serializeOrgElement(doc.children[0]);
...
Deno.test("unit: OrgSerializer: serializeOrgElement serializes pipe tables", () => {
    const raw = "| ID | Name |\n|---|---|\n| 1 | Alice |";
    const doc = parseOrgDocument(raw);
...
Deno.test("unit: OrgSerializer: serializeOrgElement serializes list checkbox items", () => {
...
Deno.test("unit: OrgSerializer: serializeOrgSubtree preserves headline title, todo, priority, and tags", () => {
...
Deno.test("unit: OrgSerializer: serializeOrgSubtree preserves planning line", () => {
...
Deno.test("unit: OrgSerializer: serializeOrgSubtree preserves property drawer entries", () => {
    const raw = "* Task\n:PROPERTIES:\n:OWNER: agent\n:END:\nContent.";
    const doc = parseOrgDocument(raw);
    const headline = doc.children[0] as OrgHeadlineElement;
    const serialized = serializeOrgSubtree(headline);
...
Deno.test("unit: OrgSerializer: serializeOrgSubtree preserves headline body text", () => {
...
Deno.test("unit: OrgSerializer: serializeOrgSubtree recursively includes child headlines", () => {
...
Deno.test("unit: OrgSerializer: serializeOrgSubtree honors dynamic todoOverrides", () => {
