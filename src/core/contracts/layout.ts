/**
 * Generic Layout Controller Contract
 * Standardizes host-specific layout management and widescreen styling.
 */

import type { ExtensionSettings } from "../storage/settings.ts";
